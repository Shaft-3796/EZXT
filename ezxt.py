...
class WrappedGenericExchange:
    ...
    @only_implemented_types
    def get_market(self, market: str, params: dict = {}) -> dict:
        """
    ...
    @only_implemented_types
    def get_precision(self, market: str, params: dict = {}) -> tuple[float, float]:
        """
    ...
    @load_markets
    @only_implemented_types
    def get_free_balance(self, token: str, params: dict = {}) -> float:
        """
    ...
    @load_markets
    @only_implemented_types
    def get_balance(self, token: str, params: dict = {}) -> float:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def get_order(self, order_id: str, market: str, params: dict = {}) -> dict:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def get_all_orders(self, market: str, params: dict = {}) -> list:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def get_all_open_orders(self, market: str, params: dict = {}) -> list:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def cancel_order_by_id(self, order_id: str, market: str, params: dict = {}) -> dict:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def cancel_order_by_object(self, order: dict, market: str, params: dict = {}) -> dict:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def get_order_status_by_id(self, order_id: str, market: str, params: dict = {}) -> str:
        """
    ...
    @only_authenticated
    @only_implemented_types
    def post_market_order(self, market: str, side: str, size: (float, int), params: dict = {}) -> dict:
        """
        Post a market order
        :param market: example "BTC/USD"
        :param side: "buy" or "sell"
